    ...
    const menuNavigation = [
        ...
        },
        {
            ...
            details: [
                {
                    title: "Kategori Blog",
                    href: route("apps.blog-categories.index"),
                    active: url.startsWith("/dashboard/blog-categories"),
                    icon: <IconCategory size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["dashboard-access"]),
                },
                {
                    title: "Tags",
                    href: route("apps.blog-tags.index"),
                    active: url.startsWith("/dashboard/blog-tags"),
                    icon: <IconList size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["dashboard-access"]),
                },
                {
                    title: "Artikel",
                    href: route("apps.blog-posts.index"),
                    active: url.startsWith("/dashboard/blog-posts"),
