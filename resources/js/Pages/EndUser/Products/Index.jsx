...
export default function Index({ products, filters, categories }) {
    ...
    const FilterContent = ({ isMobile = false }) => {
        ...
        return (
            <div
                className={`space-y-4 ${isMobile ? "" : "p-4 bg-white rounded-xl shadow-[0_1px_6px_0_rgba(49,53,59,0.12)]"}`}
            >
                {/* Category Section */}
                <div className="pb-2">
                            ...
                            {[null, 4, 3, 2, 1].map((stars) => (
                                <button
                                    ...
                                    className={`flex items-center gap-2 w-full px-3 py-2 rounded-lg text-[13px] transition-colors ${
                                        String(params.min_rating) === String(stars ?? "")
                                            ? "bg-gray-900 text-white font-bold"
                                            : "text-gray-600 hover:bg-gray-50 font-medium"
                                    }`}
                                >
    ...
    return (
        <UserLayout headerVariant="light">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="fixed inset-0 z-[60] flex md:hidden">
                                ...
                                <div className="relative max-w-[85%] w-full bg-white h-full shadow-2xl flex flex-col transform transition-transform">
                                    ...
                                    <div className="p-4 border-t border-gray-200 flex gap-3 bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                                        ...
                                        <button
                                            onClick={() => setShowMobileFilters(false)}
                                            className="w-2/3 py-2.5 bg-gray-900 text-white rounded-lg text-sm font-bold shadow-md hover:bg-gray-700 text-center"
                                        >
                                            Terapkan
                                        </button>
                                    </div>
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex justify-between items-center mb-4 bg-white p-3 md:p-4 rounded-xl shadow-[0_1px_6px_0_rgba(49,53,59,0.12)] border border-gray-100">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-[13px] text-gray-500 hidden sm:block font-medium">
                                        Urutkan:
                                    </span>
                                    <select
                                        value={params.sort}
                            ...
                            {products.data.length > 0 ? (
                                ...
                                <div className="text-center py-20 bg-white rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                                    <h3 className="text-[18px] font-bold text-gray-900">
                                        Oops, kendaraan tidak ditemukan
                                    </h3>
                                    <p className="text-[14px] text-gray-500 mt-2 max-w-sm mx-auto">
                                        Coba kata kunci lain atau hapus filter untuk melihat lebih
                                        banyak model.
                                    </p>
                                    <button
                                        onClick={() =>
                                        ...
                                        className="mt-6 px-6 py-2.5 bg-gray-900 text-white rounded-lg text-sm font-bold hover:bg-gray-700 transition-colors"
                                    >
                                        Hapus Semua Filter
                                    </button>
                                </div>
                                            ...
                                            return link.url ? (
                                                <li key={key}>
                                                    <Link
                                                        ...
                                                        className={`block px-3.5 py-2 text-[13px] font-semibold rounded-lg transition-colors min-w-[36px] text-center ${
                                                            link.active
                                                ...
                                                <li key={key}>
                                                    <span
                                                        className={`block px-3.5 py-2 text-[13px] font-semibold text-gray-400 rounded-lg min-w-[36px] text-center ${link.active ? "bg-gray-900 text-white" : "bg-transparent"}`}
                                                        dangerouslySetInnerHTML={{ __html: label }}
                                                    />
                                                </li>
                                            );
