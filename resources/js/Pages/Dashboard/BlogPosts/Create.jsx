...
export default function Create({ categories: initialCategories, tags: initialTags }) {
    const { data, setData, post, processing, errors } = useForm({
        title: "",
        blog_category_id: "",
        content: "",
        excerpt: "", // Optional, can be derived or manual
        image: null,
        tags: [],
        is_active: true,
    });
    
    // Local state for categories and tags to allow immediate updates after inline creation
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("apps.blog-posts.store"));
    };
