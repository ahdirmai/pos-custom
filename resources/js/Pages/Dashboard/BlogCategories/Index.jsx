...
export default function Index({ categories }) {
    ...
    const submit = (e) => {
        ...
        const url = editingCategory
            ? route("apps.blog-categories.update", editingCategory.id)
            : route("apps.blog-categories.store");
    ...
    const handleDelete = () => {
        if (categoryToDelete) {
            destroy(route("apps.blog-categories.destroy", categoryToDelete.id), {
                preserveScroll: true,
        ...
        <>
            ...
            <div className="mb-4 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
                <div className="w-full sm:w-80">
                    <Search
                        url={route("apps.blog-categories.index")}
            ...
            {categories.data.length > 0 ? (
                viewMode === "grid" ? (
                    ...
                    /* List View */
                    <Table.Card title={"Data Kategori Blog"}>
                        <Table>
                            <Table.Thead>
                                <tr>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                            ...
                            <div className="md:col-span-7 space-y-4">
                                <Input
                                    type="text"
                                    label="Nama Kategori"
                                    placeholder="Misal: Tips, Tutorial..."
                                    errors={errors.name}
