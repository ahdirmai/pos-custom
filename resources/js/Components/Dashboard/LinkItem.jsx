    ...
    return (
        <Link
            ...
            className={`w-full flex justify-center py-3 transition-all duration-200 ${
                isActive ? "text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-950/50" : "text-slate-500 dark:text-slate-400 hover:text-slate-700 hover:bg-slate-100"
            }`}
            {...props}
        >
            {icon}
