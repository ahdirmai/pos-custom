            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5 scrollbar-thin">
                    ...
                    {voucherApplied && (
                        <div className="flex justify-between text-sm">
                            <span className="text-indigo-600 dark:text-indigo-400 flex items-center gap-1">
                                <IconTicket size={14} /> Voucher
                            </span>
                             <span className="font-medium text-indigo-600 dark:text-indigo-400">
                                - {formatPrice(voucherApplied.amount)}
                            </span>
                        </div>
                    )}
                ...
                <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800/50">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-indigo-700 dark:text-indigo-300">Voucher</span>
                    </div>
                    ...
                    {voucherApplied ? (
                         <div className="bg-white dark:bg-slate-900 border border-indigo-200 dark:border-indigo-700 text-indigo-800 dark:text-indigo-200 px-3 py-2 rounded-lg flex items-center justify-between shadow-sm">
                             <div>
                                 <span className="font-bold text-sm block">{voucherApplied.code}</span>
                                 <span className="text-xs text-indigo-500 dark:text-indigo-400">
                                     Hemat {formatPrice(voucherApplied.amount)}
                                 </span>
                             </div>
                             <button
                        ...
                        <div className="flex gap-2">
                             <input
                                ...
                                className="flex-1 h-10 px-3 text-sm rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 uppercase placeholder:normal-case"
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter') {
                                        e.preventDefault();
                            ...
                            <button
                                type="button"
                                onClick={() => onCheckVoucher(voucherCode)}
                                disabled={!voucherCode || checkingVoucher}
                                className="h-10 px-4 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center min-w-[80px]"
                            >
                                {checkingVoucher ? (
